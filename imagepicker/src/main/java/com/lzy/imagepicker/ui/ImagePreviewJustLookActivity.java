 ...
 * ================================================
 */
public class ImagePreviewJustLookActivity extends ImagePreviewBaseActivity implements ImagePicker.OnImageSelectedListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
...
//    private SuperCheckBox mCbOrigin;               //原图
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isOrigin = getIntent().getBooleanExtra(ImagePreviewJustLookActivity.ISORIGIN, false);
        ...
        mCbCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCbCheck.isChecked() && selectedImages.size() >= selectLimit) {
                    Toast.makeText(ImagePreviewJustLookActivity.this, getString(R.string.ip_select_limit, selectLimit), Toast.LENGTH_SHORT).show();
        ...
        NavigationBarChangeListener.with(this).setListener(new NavigationBarChangeListener.OnSoftInputStateChangeListener() {
            ...
            public void onNavigationBarShow(int orientation, int height) {
                ...
                if (layoutParams.height == 0) {
                    layoutParams.height = Utils.getNavigationBarHeight(ImagePreviewJustLookActivity.this);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_ok) {
            ...
            Intent intent = new Intent();
            intent.putExtra(ImagePreviewJustLookActivity.ISORIGIN, isOrigin);
